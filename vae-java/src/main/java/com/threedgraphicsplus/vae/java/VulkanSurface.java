package com.threedgraphicsplus.vae.java;
...
public class VulkanSurface extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    public VulkanSurface(Context ctx, AttributeSet att){
        super(ctx,att);
        context = ctx;
    ...
    public VulkanSurface(Context _context) {
        super(_context);
        context =_context;
        SurfaceHolder holder = getHolder();
        holder.addCallback(this);
